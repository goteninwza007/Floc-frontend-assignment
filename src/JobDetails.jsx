    ...
    return (
        <div className='w-full flex justify-center'>
            <div className='container'>
                ...
                <div className="mt-6 w-[90%] xl:w-full h-2/3 bg-white rounded-[38px] border-2 border-black drop-shadow-[9px_9px_rgba(0,0,0,1)] flex flex-row p-4 xl:p-12 mx-auto">
